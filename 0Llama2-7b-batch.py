...
def writehistory(text):
    ...
    f.close()
# TITLE section
console.print(Panel("Your AI generation with [yellow]Llama2-7b GGML"))
...
for item in lista:
        ...
        # put together the instruction in the prompt template for Llama models
        ...
        bottext = f"Llama2-7b : {res}\ntext generated in {gen_time}\n---\n"
        writehistory(bottext)
        console.print(f"[yellow1]Llama2-7b :llama: : {res}")
