...
# TITLE section
llm = Llama(model_path="./models/orca-mini-3b.ggmlv3.q4_1.bin", n_ctx=1024, n_batch=32, verbose=False)
...
console.print(Panel("Your AI generation with [yellow]Orca-3b GGML"))
...
for item in lista:
        ...
        bottext = f"Orca3b : {res}\ntext generated in {gen_time}\n---\n"
        writehistory(bottext)
        console.print(f"[yellow1]Orca3b :whale: : {res}")
